...
# Bleumi Pay for Drupal Commerce 8.x
...
With this extension, customers can make stablecoin payments (cryptocurrencies designed to mimic the value of fiat money like the dollar or the euro) in your Drupal Commerce 8.x Store.
...
To use this plugin with your Drupal Commerce 8.x store you will need:

- Commerce 2.x ([Installation guide](https://docs.drupalcommerce.org/commerce2/developer-guide/install-update/installation)) 
...
Step 2: Install, Enable & Configure Bleumi Pay In Your Drupal Commerce 8.x Store

Please refer to the [Bleumi Pay - Installation Guide for Drupal Commerce 8.x](Bleumi%20Pay%20-%20Installation%20Guide%20for%20Drupal%20Commerce%208.x.pdf) for complete details.
